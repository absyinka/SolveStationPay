...
namespace SolveStationPay.Persistence.Migrations
{
    ...
    [Migration("20200206085655_Intial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SolveStationPay.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SolveStationPay.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SolveStationPay.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SolveStationPay.Entity.PaymentRecord", b =>
                {
                    b.HasOne("SolveStationPay.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SolveStationPay.Entity.TaxYear", "TaxYear")
                        .WithMany()
